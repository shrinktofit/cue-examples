...
src/flex-playground.cue and src/text-playground.cue are compiled by the workspace build into the
ignored src/generated/cue directory. src/index.ts imports those generated facades and mounts the
selected page on a CueDocument in the active Cocos scene.
...
Open assets/main.scene and start Preview. The Cocos UI control plane provides two independent pages:
